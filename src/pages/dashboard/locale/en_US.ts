const en_US = {
  ...
  batch: {
    ...
    import_grafana: 'Import Grafana',
    import_grafana_tip:
      'Currently only support import dashboard config of v8+ version, imported panels only support the chart types and features that n9e currently supports',
  },
  link: {
    title: 'Links',
    name: 'Name',
  ...
  share_record: {
    title: 'Chart sharing record',
    search_placeholder: 'Username, display name,note',
    url: 'Access link',
    user: 'Share user',
    expiration: 'Expiration',
    long_term: 'Long-term effectiveness',
    no_limit_user: 'There is no limit to viewing users',
    edit_share_record: 'Edit share record',
  },
};
