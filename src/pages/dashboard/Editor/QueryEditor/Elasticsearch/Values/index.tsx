...
const functions = ['count', 'avg', 'sum', 'max', 'min', 'p90', 'p95', 'p99', 'rate', 'rawData'];
...
export default function index({
  ...
  const { run } = useDebounceFn(
    () => {
      getFields(datasourceValue, index, 'number', curBusiId).then((res) => {
        setFieldsOptions(
                      ...
                      <Row gutter={10}>
                        <Col flex='auto'>
                          <Row gutter={10}>
                            ...
                            {func !== 'count' && func !== 'rawData' && func !== 'rate' && (
                              <Col span={12}>
                            ...
                            {func === 'rate' && (
                              <Col span={12}>
                                <InputGroupWithFormItem label='Rate unit' labelWidth={80}>
                                  <Form.Item
                                    {...field}
                                    name={[field.name, 'field']}
                                    rules={[{ required: true, message: '必须选择 rate unit' }]}
                                  >
