...
export default function List(props: IProps) {
  ...
  const { profile, curBusiId } = useContext(CommonStateContext);
  useEffect(() => {
    const defaultMetricViewId =
      localStorage.getItem('metric-view-id') !== null ? Number(localStorage.getItem('metric-view-id')) : null;
    getList().then((res) => {
      setList(res);
      let curId;
  ...
  }, [refreshFlag, props.datasourceValue, curBusiId]);
