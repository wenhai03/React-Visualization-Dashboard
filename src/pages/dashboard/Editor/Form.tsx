...
// import { mergeTwoVarOption, updatePanelsInsertRowVarOptions } from '../Panels/utils';
...
function FormCpt(props: IProps, ref) {
  ...
  const [variableConfigWithOptions, setVariableConfigWithOptions] = useState<IVariable[] | undefined>(
    props.variableConfigWithOptions,
  );
                      ...
                      <div style={{ marginBottom: 10 }}>
                        <VariableConfig
                          onChange={(value, bool, withOptions) => {
                            ...
                            // if (setPanels) {
                            //   const newPanels = updatePanelsInsertRowVarOptions(
                            //     panels,
                            //     initialValues.rowId,
                            //     withOptions,
                            //   );
