        ...
        return (
          <>
            {text
              ? text.map((tag, index) => {
                  return tag ? (
                    <div key={index} style={{ lineHeight: '16px' }}>{`${tag.key} ${tag.func} ${
                ...
                <>
                  <div className='table-operator-area'>
                    <div
                      ...
                      onClick={() => {
                        history.push(`/alert-mutes/edit/${record.id}?bgid=${bgid}&mode=clone`, {
                          ...record,
              ...
              {curBusiGroup.perm === 'rw' && (
                <div className='header-right'>
                  <Button
                    ...
                    className='add'
                    onClick={() => {
                      history.push(`/alert-mutes/add?bgid=${bgid}`);
                    }}
                  >
                    {t('common:btn.add')}
                  </Button>
