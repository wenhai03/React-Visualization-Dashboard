const zh_HK = {
  ...
  notify_repeat_step_tip: `如果告警持續未恢復，重復提醒告警接收團隊的成員：
  若間隔時間 <= 執行頻率，將按照執行頻率通知
  若間隔時間 > 執行頻率，將按照間隔時間通知`,
  notify_max_number: '最大發送次數',
  notify_max_number_tip: '如果值為 0，則不做最大發送次數的限制',
  notify_channels_tip: '機器人token可通過右上角的 個人信息-更多聯繫方式 進行配置',
  callbacks: '回撥地址',
  annotations: '附加資訊',
  annotationsOptions: {
    plan_link: '預案連結',
  ...
  host: {
    ...
    prom_eval_interval_tip: '執行頻率，每隔 {{num}} 秒查詢是否異常',
