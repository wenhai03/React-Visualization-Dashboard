...
export default function DatasourceSelect({ chartForm, variableConfig, groupedDatasourceList }) {
  ...
  // console.log('datasourceVars --->', datasourceVars)
          ...
          return (
            <Input.Group compact>
              ...
              >
                <Select
                  allowClear
                  placeholder={t('query.datasource_placeholder')}
                  style={{ minWidth: 70 }}
                  dropdownMatchSelectWidth={false}
                  showSearch
