const en_US = {
  ...
  rule_prod_firemap: 'Firemap',
  rule_prod_northstar: 'Northstar',
  ...
  detail: {
    ...
    rule_note: 'Trigger notification',
    cate: 'Datasource Type',
    rule_prod: 'Alarm source',
    ...
    notify_groups_obj: 'Notify Teams',
    callbacks: 'Callbacks',
    ...
    log_detail: 'Alarm detail',
    view_trace: 'Viewing links',
    view_log: 'View logs',
    doc: 'Document',
    annotations: 'Annotations',
    anti_alarm:
      'The alarm you view has been eliminated and will go to the historical alarm after {{countdown}} seconds.',
  },
};
