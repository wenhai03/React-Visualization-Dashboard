              ...
              {_.map(fields, (field, index) => {
                return (
                  ...
                  >
                      ...
                      >
                        {({ getFieldValue }) => {
                          ...
                          datasourceValue = variableConfig
                            ? replaceExpressionVars(datasourceValue, variableConfig, variableConfig.length, dashboardId)
                            : datasourceValue;
                          return (
                            <Form.Item
                              label='PromQL'
                    ...
                    <Row gutter={10}>
                      {/* legend 填写变量可以取自 PromQL 查出来的标签名 */}
                      <Col flex='auto'>
                        <Form.Item
                          label='Legend'
                          {...field}
                      ...
                      <Col flex='116px'>
                        <Form.Item
                          ...
                          normalize={(val) => {
                            return {
                              start: isMathString(val.start)
                                ? val.start
                                : moment(val.start).format('YYYY-MM-DD HH:mm:ss'),
