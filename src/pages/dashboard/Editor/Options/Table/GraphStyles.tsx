    ...
    <Panel header={t('panel.custom.title')}>
      <>
        <Row gutter={10}>
          <Col span={12}>
            <Form.Item
              label={t('panel.custom.table.showHeader')}
              name={[...namePrefix, 'showHeader']}
        ...
        <Row gutter={10}>
          ...
          <Form.Item
            ...
            shouldUpdate={(prevValues, curValues) =>
              _.get(prevValues, [...namePrefix, 'displayMode']) !== _.get(curValues, [...namePrefix, 'displayMode'])
            }
          >
            {({ getFieldValue }) => {
                  ...
                  <Col span={12}>
                    <Form.Item label={t('panel.custom.table.columns')} name={[...namePrefix, 'columns']}>
                      <Select mode='multiple' placeholder='' suffixIcon={<CaretDownOutlined />}>
                        {_.map(_.concat(tableFields, 'value'), (item, index) => {
                          return (
